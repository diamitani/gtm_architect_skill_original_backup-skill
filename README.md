# gtm_architect_skill_original_backup

**Category:** 03-gtm-sales
**Source:** gtm-architect-SKILL-original-backup.md
...
1. Clone this repository:
   ```bash
   git clone https://github.com/diamitani/gtm_architect_skill_original_backup-skill.git
   ```
...
2. Import the skill into your agent framework:
   ...
   # For Hermes Agent
   skill_view(name='gtm_architect_skill_original_backup')
   ```
