...
description: >
  ...
  (contacts, companies, deals, properties), Amplemarket (sequences, enrollment, campaigns), or
  Mermaid diagrams (workflow charts, system diagrams, Gantt plans for ELT/stakeholders). Also
  ...
  "competitive positioning", "objection handling", or any request to automate, wire, diagram,
  or build anything across the {{COMPANY_NAME}} GTM stack.
---
